            ...
            <nav className='flex flex-row-reverse items-center justify-end w-full p-2 shadow-md md:justify-normal md:flex-row bg-primary '>
                ...
                <div className='hidden md:flex md:flex-row'>
                    <div className='flex flex-row items-center'>
                        <NavLink to="/search" className=' mx-5 text-sm whitespace-nowrap'>SEARCH</NavLink>
                        <NavLink to="/addDocs" className=' mx-5 text-sm whitespace-nowrap'>COMPANY DOCS</NavLink>
                        <NavLink to="/history" className=' mx-5 text-sm whitespace-nowrap flex-grow'>YOUR PREVIOUS QUESTIONS</NavLink>
                        <NavLink to="/account" className='mx-5'>
